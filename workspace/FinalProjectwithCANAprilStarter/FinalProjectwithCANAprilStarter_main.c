// Comments marked by initials ER, KP, KL, DS, EC
//#############################################################################
...
__interrupt void cpu_timer2_isr(void)
{
    ...
    PostSWI3(); //Added PostSWI3 for Lab 7 Ex.1 Step 1 - DS
    ...
    if(calibration_state == 0){
        ...
        case 1: // command the robot to an X,Y point in the course - KL
            ...
            if (statecount<=2000){
                ...
                if (MaxAreaThreshold2 > 30) { // same detection threshold but for orange ball - DS
                    RobotState = 30;
                    statecount =0;
                }
            }
